package com.kirwafood.foodrecipes.adapters;
...
import com.kirwafood.foodrecipes.R;
...
//                    .setDefaultRequestOptions(requestOptions)
            ...
            Uri path = Uri.parse("android.resource://com.kirwafood.foodrecipes/drawable/" + mRecipes.get(i).getImage_url());
            Glide.with(viewHolder.itemView.getContext())
                    .setDefaultRequestOptions(requestOptions)
                    .load(path)
